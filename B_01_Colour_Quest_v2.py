...
def get_round_colours():
    ...
    :return: list of colours and score to beat (meadian of scores)
    """
    ...
    while len(round_colours) < 4:
        ...
        if potential_colour[1] not in colour_scores:
            ...
            # make score an internet and add it to the list of scores
...
class Play:
    ...
    def new_round(self):
        ...
        # configure button using foreground and background colours from list
    ...
    def round_results(self, user_choice):
        ...
        # retrieve target score and compare with user score to din round result
...
class DisplayHints:
    ...
    def __init__ (self, partner):
        ...
        help_text = ("To use the program, simply enter the temperature "
                     "you wish to convert and the choose to convert to either "
                     "degrees Celsius (centigrade) or Fahrenheit..\n\n "
                     "Note that -273 degrees C (-459 F) "
                     "is absolute zero ( the coldest possible Temperature ). "
                     "IF you try to convert a temperature that "
                     "is less than -273 degrees C. you will get "
                     "an error message. \n\n T0 see your calculation history "
                     "and export it to a test file, please click the "
